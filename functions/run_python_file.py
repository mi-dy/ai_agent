...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Runs the target python file in working directory with optional arguments if they were given",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="File path to the python file that we want to run",
            ),
            "args": types.Schema(
                type=types.Type.ARRAY,
                description="Optional arguments to pass to the python command",
